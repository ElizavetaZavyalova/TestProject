...
class DateBaseConnectorTest {
    ...
    @Test
    void readFromTablesAndParseDate() throws SQLException, IOException {
        ...
        assertTrue(info.containsKey(("USERS+ID".toUpperCase())));
        assertTrue(info.containsKey(("accounts+account".toUpperCase())));
        assertTrue(info.containsKey(("accounts+account_id".toUpperCase())));
    }
}